...
#########################
data = read.table("ndn_attack_L3-rate-trace.txt", header=T)
...
data.leaves = subset(data.combined, Node %in% c("user-1", "user-2", "user-3", "auser-4", "user-5", "user-6", "user-7", "auser-8"))
